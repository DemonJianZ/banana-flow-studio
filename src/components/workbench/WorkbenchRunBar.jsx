  ...
  return (
    <div className="absolute bottom-6 right-6 z-50 flex gap-2 select-none">
      ...
      <button
        ...
        className="relative rounded-[16px] border border-slate-200 bg-white p-2 text-slate-500 shadow-[0_18px_36px_rgba(15,23,42,0.08)] transition-colors hover:bg-slate-50 hover:text-slate-900"
        title="Reset View"
      >
